...
/**
 * Response encoder for the SensorThings API Observations resource, used by GetObservationById operations.
 *
 * @author <a href="mailto:m.kiesow@52north.org">Martin Kiesow</a>
 */
public class StaGetObservationByIdResponseEncoder extends StaAbstractGetObservationResponseEncoder<GetObservationByIdResponse> {
