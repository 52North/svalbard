...
public class StaDatastreamEncoder extends JSONEncoder<StaDatastream> {
    ...
    @Override
    public JsonNode encodeJSON(StaDatastream t) throws EncodingException {
        ObjectNode json = nodeFactory().objectNode();

        json.put(StaConstants.STA_ANNOTATION_ID, t.getId());
...
//        }
//        t.getObservationCollection().forEach(o -> json.set(StaConstants.STA_RESOURCE_RELATION_OBSERVATIONS, encodeObjectToJson(o)));
